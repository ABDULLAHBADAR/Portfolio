          ...
          <div id="skills-page" className="row h-100">
            ...
            <div className="col-11 col-sm-6 col-md-5 col-lg-6 col-xl-5 d-flex justify-content-center  align-items-sm-center justify-content-md-start justify-content-sm-center justify-content-lg-center  ">
              <div className="row row-cols-3">
                ...
                <img src={ROR} className="card-img-top" alt="..."/>

                  <div className="card-body">
                    <h5 className="card-title text-white text-center fs-5">Ruby on Rails</h5>
                  </div>
                </div>
                </div>
                <div className="col">
                ...
                <div className="card d-flex flex-column align-items-center">
                  ...
                  <div className="card-body">
                    <h5 className="card-title text-white text-center fs-5">MERN</h5>
                  </div>
                </div>
                </div>
                <div className="col">
                <div className="card d-flex flex-column align-items-center">
                  ...
                  <div className="card-body">
                    <h5 className="card-title text-white text-center fs-5">AWS</h5>
                  </div>
                </div>
                </div>
                <div className="col">
                <div className="card d-flex flex-column align-items-center">
                  <img src={DOCKER} className="card-img-top" alt="..." />
                  <div className="card-body">
                    <h5 className="card-title text-white text-center fs-5">Docker</h5>
                  </div>
                </div>
                </div>
                <div className="col">
